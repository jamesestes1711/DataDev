...
<script src="functions.js"></script>
    ...
    title = "Untitled Mech Game | Deep Dive Gaming | ";
    position = 0;
...
<body onload="startTime()"
    style="background-image: url('img/Picture5.png'); background-repeat: no-repeat; background-size: cover; background-size: 100% 100%;">
    <center>
