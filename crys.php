...
OpenCon();
$temp1 = mysqli_query($conn, "SELECT * FROM CRYS_CREA_MERCH WHERE ID=1");
$final1 = mysqli_fetch_assoc($temp1) or die("Query to array failed");
$temp2 = mysqli_query($conn, "SELECT * FROM CRYS_CREA_MERCH WHERE ID=2");
$final2 = mysqli_fetch_assoc($temp2) or die("Query to array failed");
$temp3 = mysqli_query($conn, "SELECT * FROM CRYS_CREA_MERCH WHERE ID=3");
$final3 = mysqli_fetch_assoc($temp3) or die("Query to array failed");
$temp4 = mysqli_query($conn, "SELECT * FROM CRYS_CREA_MERCH WHERE ID=4");
$final4 = mysqli_fetch_assoc($temp4) or die("Query to array failed");
$temp5 = mysqli_query($conn, "SELECT * FROM CRYS_CREA_MERCH WHERE ID=5");
$final5 = mysqli_fetch_assoc($temp5) or die("Query to array failed");
$temp6 = mysqli_query($conn, "SELECT * FROM CRYS_CREA_MERCH WHERE ID=6");
$final6 = mysqli_fetch_assoc($temp6) or die("Query to array failed");
$temp7 = mysqli_query($conn, "SELECT * FROM CRYS_CREA_MERCH WHERE ID=7");
$final7 = mysqli_fetch_assoc($temp7) or die("Query to array failed");
$temp8 = mysqli_query($conn, "SELECT * FROM CRYS_CREA_MERCH WHERE ID=8");
$final8 = mysqli_fetch_assoc($temp8) or die("Query to array failed");
$temp9 = mysqli_query($conn, "SELECT * FROM CRYS_CREA_MERCH WHERE ID=9");
$final9 = mysqli_fetch_assoc($temp9) or die("Query to array failed");
$temp10 = mysqli_query($conn, "SELECT * FROM CRYS_CREA_MERCH WHERE ID=10");
$final10 = mysqli_fetch_assoc($temp10) or die("Query to array failed");
$temp11 = mysqli_query($conn, "SELECT * FROM CRYS_CREA_MERCH WHERE ID=11");
$final11 = mysqli_fetch_assoc($temp11) or die("Query to array failed");
$temp12 = mysqli_query($conn, "SELECT * FROM CRYS_CREA_MERCH WHERE ID=12");
$final12 = mysqli_fetch_assoc($temp12) or die("Query to array failed");
$temp13 = mysqli_query($conn, "SELECT * FROM CRYS_CREA_MERCH WHERE ID=13");
$final13 = mysqli_fetch_assoc($temp13) or die("Query to array failed");
$temp14 = mysqli_query($conn, "SELECT * FROM CRYS_CREA_MERCH WHERE ID=14");
$final14 = mysqli_fetch_assoc($temp14) or die("Query to array failed");
$temp15 = mysqli_query($conn, "SELECT * FROM CRYS_CREA_MERCH WHERE ID=15");
$final15 = mysqli_fetch_assoc($temp15) or die("Query to array failed");
$temp16 = mysqli_query($conn, "SELECT * FROM CRYS_CREA_MERCH WHERE ID=16");
$final16 = mysqli_fetch_assoc($temp16) or die("Query to array failed");
$temp17 = mysqli_query($conn, "SELECT * FROM CRYS_CREA_MERCH WHERE ID=17");
$final17 = mysqli_fetch_assoc($temp17) or die("Query to array failed");
$temp18 = mysqli_query($conn, "SELECT * FROM CRYS_CREA_MERCH WHERE ID=18");
$final18 = mysqli_fetch_assoc($temp18) or die("Query to array failed");
$temp19 = mysqli_query($conn, "SELECT * FROM CRYS_CREA_MERCH WHERE ID=19");
$final19 = mysqli_fetch_assoc($temp19) or die("Query to array failed");
$temp20 = mysqli_query($conn, "SELECT * FROM CRYS_CREA_MERCH WHERE ID=20");
$final20 = mysqli_fetch_assoc($temp20) or die("Query to array failed");
$temp21 = mysqli_query($conn, "SELECT * FROM CRYS_CREA_MERCH WHERE ID=21");
$final21 = mysqli_fetch_assoc($temp21) or die("Query to array failed");
$temp22 = mysqli_query($conn, "SELECT * FROM CRYS_CREA_MERCH WHERE ID=22");
$final22 = mysqli_fetch_assoc($temp22) or die("Query to array failed");
$temp23 = mysqli_query($conn, "SELECT * FROM CRYS_CREA_MERCH WHERE ID=23");
$final23 = mysqli_fetch_assoc($temp23) or die("Query to array failed");
$temp24 = mysqli_query($conn, "SELECT * FROM CRYS_CREA_MERCH WHERE ID=24");
$final24 = mysqli_fetch_assoc($temp24) or die("Query to array failed");
$temp25 = mysqli_query($conn, "SELECT * FROM CRYS_CREA_MERCH WHERE ID=25");
...
<html>
  ...
  <body style="background-image: url('img/Picture7.png'); background-repeat: no-repeat; background-size: cover; background-size: 100% 100%;">
    <center>
    ...
    <div id="merch" style="float: right; padding-top: 0px;">
      <table id="merch" width="90%" style="padding-left: 20%; padding-top: 20%;">
        ...
        <tr id="m_con" style="height: 95%;">
          ...
          <th style="width: 25%;">
            <img src="img/newcc/Creatures (Poster)/Hisnotized.png" width="45%" height="15%" alt="Leaderboards"/>
        ...
        <tr id="m_con" style="height: 95%;">
          ...
          <th style="width: 25%;">
            <img src="img/newcc/Creatures (Poster)/Pandemickey.png" width="25%" height="25%" alt="Leaderboards"/>
        ...
        <tr id="m_con" style="height: 55%;">
          ...
          <th style="width: 25%;">
            <img src="img/newcc/Creatures (Poster)/Tamers/Shinrai Dekinai.png" width="55%" height="55%" alt="Leaderboards"/>
